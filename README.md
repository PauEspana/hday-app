...
Recorda que el codi Java es pot llegir quan s'hi té accés. Si el fitxer `app.Quiz.java` cau en mans equivocades es podrà llegir la contrasenya i accedir a la base de dades. En canvi, el fitxer `hday.jar` serà un fitxer compilat i serà més dificil llegir-lo. 
